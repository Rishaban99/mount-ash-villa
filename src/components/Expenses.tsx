...
import { Expense, User, Bill } from '../types';
import { isStaffActiveForMonth } from '../utils/staffPayroll';
import { 
  Plus, 
  Search, 
  Edit2, 
...
export const Expenses: React.FC<ExpensesProps> = ({ currentUser, initialAction, onClearAction, onClose, onNavigateTab }) => {
